...
<div class="third-section">
  <div class="third-section-vector-wrapper">
    <svg width="1300" height="157.5" viewBox="0 0 1600 194" fill="none">
  ...
  <h1 class="third-section-title wow animate__lightSpeedInLeft">Наборы макаронc</h1>
  <p class="third-section-text">
    Здесь вы можете ознакомиться с нашей работой
  </p>

  <div id="macarons-sets" class="swiper third-section-menu-wrapper">
  ...
  <!-- <div class="third-section-menu-box">
        <div class="third-section-menu-box-heart-wrapper">
          ...
          <div class="third-section-menu-box-img-setOne"></div>
         </div>
          
          <div class="third-section-menu-box-rect">
            <p class="third-section-menu-box-text">Наш набор из 6 разных макарон.</p>
          </div>
          <div class="third-section-menu-box-price-wrapper">
            <p class="third-section-menu-box-price">Цена: 25 BYN</p>
        ...
        <div class="third-section-menu-box-heart-wrapper">
          ...
          <div class="third-section-menu-box-img-wrapper" >
          <div class="third-section-menu-box-img-setTwo"></div>
          </div>
          <div class="third-section-menu-box-rect">
            <p class="third-section-menu-box-text">Наш набор из 24 разных макарон.</p>
          </div>
          <div class="third-section-menu-box-price-wrapper">
            <p class="third-section-menu-box-price">Цена: 120 BYN</p>
            <button class="third-section-menu-box-button">Добавить</button>
          </div>
        </div>
        <div class="third-section-menu-box">
        <div class="third-section-menu-box-heart-wrapper">
          ...
          <div class="third-section-menu-box-img-wrapper" >
          <div class="third-section-menu-box-img-setThree"></div>
          </div>
          <div class="third-section-menu-box-rect">
            <p class="third-section-menu-box-text">Набор из 12 разных макарон.</p>
          </div>
          <div class="third-section-menu-box-price-wrapper">
            <p class="third-section-menu-box-price">Цена: 70 BYN</p>
            <button class="third-section-menu-box-button">Добавить</button>
          </div>
        </div>
      </div>
